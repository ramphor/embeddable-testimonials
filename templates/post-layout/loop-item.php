<div <?php post_class('loop-item'); ?>>
    ...
    <div class="post-thumbnail">
        <?php do_action('jankx_testimonial_layout_before_loop_post_thumbnail', $post, $data_index); ?>
        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
            <?php jankx_the_post_thumbnail($thumbnail_size); ?>
        </a>
        <?php do_action('jankx_testimonial_layout_after_loop_post_thumbnail', $post, $data_index); ?>
    </div>
    <?php endif; ?>
